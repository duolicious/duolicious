...
from serviceshared.notify import enqueue_mobile_notification, _batcher
import asyncio
import json
...
class TestSendMobileNotification(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_enqueue_mobile_notification_success(self) -> None:
        ...
        with patch('serviceshared.notify.make_http_client', factory), \
                patch('serviceshared.notify.NOTIFICATION_API_URL', 'http://localhost'):
