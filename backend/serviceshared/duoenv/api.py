...
SPOTIFY_REDIRECT_URI = required_str('DUO_SPOTIFY_REDIRECT_URI')
SPOTIFY_AUTHORIZE_URL = str_with(
    'DUO_SPOTIFY_AUTHORIZE_URL',
    'https://accounts.spotify.com/authorize',
)
SPOTIFY_WEB_REDIRECT_URL = stripped_str('DUO_SPOTIFY_WEB_REDIRECT_URL')
SPOTIFY_APP_REDIRECT_URL = stripped_str('DUO_SPOTIFY_APP_REDIRECT_URL')
