...
PAYPAL_CLIENT_ID = stripped_str('DUO_PAYPAL_CLIENT_ID')
PAYPAL_CLIENT_SECRET = stripped_str('DUO_PAYPAL_CLIENT_SECRET')
PAYPAL_PLAN_ID = stripped_str('DUO_PAYPAL_PLAN_ID')
PAYPAL_WEBHOOK_ID = stripped_str('DUO_PAYPAL_WEBHOOK_ID')
