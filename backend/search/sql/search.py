...
def build_uncached_search(
    ...
    body, params = _uncached_search_body(searcher_person_id, n, o, prefs)
...
def build_unordered_uncached_search(
    searcher_person_id: int,
    n: int,
    o: int,
    prefs: Row,
) -> tuple[str, dict[str, SearchParam]]:
    return _uncached_search_body(searcher_person_id, n, o, prefs)
