...
def run_notify_of_visit(
    ...
    with (
        patch('visitornotification.api_tx', api_tx),
        patch('visitornotification.fetch_push_tokens',
              new_callable=AsyncMock,
              return_value=['phone'] if tokens is None else tokens),
        patch('visitornotification.increment_unseen_notification_count',
              new_callable=AsyncMock, return_value=badge),
        patch('visitornotification.notify.enqueue_mobile_notification',
