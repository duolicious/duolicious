...
// Spotify's branding guidelines. Displaying it alongside the artists is
// required attribution: https://developer.spotify.com/policy
...
const inkColor = (appTheme: AppTheme, color: unknown) =>
